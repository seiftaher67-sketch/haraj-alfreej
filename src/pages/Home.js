...
function Home() {
  ...
  const images = ['/assets/images/images/toyota1.jpeg', '/assets/images/images/toyota2.jpeg', '/assets/images/images/other1.jpeg', '/assets/images/images/other2.jpeg'];
      ...
      <div className="flex items-center animate-marquee">
        {[...images, ...images].map((img, idx) => (
          <img
            ...
            src={encodeURI(img)}
            alt="brand"
            className={`w-24 h-24 object-cover rounded-lg flex-shrink-0 ${idx % 2 === 1 ? '-ml-12' : ''}`}
          />
        ))}
      </div>
    </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/vehicles" className="inline-flex items-center">
              <span className="group inline-flex items-center gap-3 border-2 border-red-500 text-red-500 px-4 py-2 rounded-lg transition-colors duration-200 hover:bg-red-500 hover:text-white animate-blink-red">
                {/* أيقونة مثلث */}
                <span className="flex items-center justify-center w-8 h-8 border-2 border-red-500 group-hover:border-white group-hover:bg-white/20 transition-all" style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative w-full overflow-hidden mb-6">
            <div className="flex items-center gap-3 animate-marquee">
              {['شاحنات','سيارات','مقطورات','قطع غيار', 'شاحنات','سيارات','مقطورات','قطع غيار'].map((c, idx) => (
                <button key={`${c}-${idx}`} className="px-4 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-[#0b0b0b] whitespace-nowrap">
                  {c}
                </button>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex items-center justify-between mb-6 gap-6">
            <div className="flex items-center gap-4">
              <img
                ...
                alt="الفريج"
                className="h-16 w-16 rounded-full object-cover shadow-md border-2 border-white animate-logo"
              />
          ...
          <div className="bg-white/95 rounded-2xl shadow-lg p-4">
            ...
            <div className="flex justify-center mt-6">
              <button  className="bg-[#f2b400] hover:bg-[#d19b00] text-[#0b0b0b] py-3 px-12 rounded-lg font-bold shadow">
              تسجيل في المزايده
              </button>
