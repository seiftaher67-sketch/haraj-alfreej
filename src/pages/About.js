...
const About = () => {
  return (
    <div className="bg-white text-gray-800" dir="rtl">
      {/* ===== Hero Section ===== */}
      <section className="relative bg-black text-white text-center py-12 md:py-24">
        <img
        ...
        <div className="relative z-20 container mx-auto px-4">
          ...
          />
          <h1 className="text-xl md:text-3xl font-bold">تأسس معرض الفريج سنة 1975</h1>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="flex items-center gap-2 mb-6">
                ...
                <h2 className="text-xl md:text-3xl font-bold text-gray-800">رؤيتنا</h2>
              </div>
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h3 className="text-xl md:text-3xl font-bold mb-6 text-gray-800">رؤيتنا المستقبلية 2030</h3>
              <p className="leading-8 text-gray-700 text-base md:text-lg">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <p className="leading-8 text-gray-700 text-base md:text-lg"> السلام عليكم ورحمة الله وبركاته، شركة علي عبد الله الفريج وأولاده هي : </p>
          ...
          <motion.img
            ...
            alt="Company Intro"
            className="rounded-xl w-full md:w-96 h-64 md:h-96 object-cover hover:scale-105 transition-transform duration-300"
            initial={{ opacity: 0, x: 40 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
          />
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <div className="bg-white p-4 md:p-6 rounded-2xl shadow-lg border-l-4 border-blue-500">
                ...
                <h4 className="font-bold text-blue-600 mb-4 text-lg md:text-xl">المزايدات تشمل:</h4>
            ...
            <motion.img
              ...
              alt="Auction Image"
              className="rounded-2xl shadow-xl hover:scale-105 transition-transform duration-300 w-full h-64 md:h-80 object-cover"
              initial={{ opacity: 0, x: 40 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
            />
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <div className="bg-white p-4 md:p-6 rounded-2xl shadow-lg border-l-4 border-yellow-500">
                ...
                <h4 className="font-bold text-yellow-600 mb-4 text-lg md:text-xl">مزايا الخدمة:</h4>
        ...
        <div className="container mx-auto px-4 py-8 md:py-0">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center h-full">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="text-2xl md:text-4xl font-bold text-gray-800">تحميل تطبيق حراج الفريج</h2>
              <p className="leading-8 text-gray-700 text-base md:text-lg">
            ...
            >
              <img
                ...
                alt="Mobile App"
                className="w-64 md:w-80 lg:w-[420px] h-auto md:h-[500px] object-cover object-top"
